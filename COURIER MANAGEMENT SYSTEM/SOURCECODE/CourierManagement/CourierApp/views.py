...
def ViewFeedback(request):
    if request.method == 'GET':
        ...
        rank = []
        con = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = '', database = 'courier',charset='utf8')
        with con:
            cur = con.cursor()
...
def UpdateCourierAction(request):
    if request.method == 'POST':
        ...
        db_connection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = '', database = 'courier',charset='utf8')
